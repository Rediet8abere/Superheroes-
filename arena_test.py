...
# #     assert big_strength
#
# def test_teamone_instance():
#     # Test instantiation without error
#     team_one = superheroes.Arena("Power Rangers")
#     assert team_one
#
# def test_teamtwo_instance():
#     # Test instantiation without error
#     team_two = superheroes.Arena("Avengers")
#     assert team_two
#
#
...
#
# def test_teamone_name():
#     # Test for Correct Name
#     team_one = superheroes.Arena("Power Rangers")
#     assert team_one.name == "Power Rangers"
#
# def test_teamtwo_name():
#     # Test for Correct Name
#     team_two = superheroes.Arena("Avengers")
#     assert team_two.name == "Avengers"
#
#
